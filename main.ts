...
game.setDialogFrame(img`
    ...
    ..99999999999999999999..
    `)
game.showLongText("you are stock in Arizona", DialogLayout.Bottom)
game.showLongText("you only have 2$ and an Arizona iced tea", DialogLayout.Bottom)
if (game.ask("drink iced tea", "wolk 10 miles")) {
    gameover("The iced tea make you more thirst you die")
} else {
    scene.setBackgroundImage(img`
        9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
